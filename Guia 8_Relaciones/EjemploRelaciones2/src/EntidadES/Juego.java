...
public class Juego {
    ...
    // â€¢ llenarJuego(ArrayList<Jugador>jugadores, Revolver r): este mÃ©todo recibe
    // los jugadores
    // y el revolver para guardarlos en los atributos del juego.
    // â€¢ ronda(): cada ronda consiste en un jugador que se apunta con el revolver de
    // agua y aprieta el gatillo.
    // SÃ­ el revolver tira el agua el jugador se moja y se
    // termina el juego, sino se moja, se pasa al siguiente jugador hasta que uno se
    // moje.
    // Si o si alguien se tiene que mojar.
    // Al final del juego, se debe mostrar que jugador se mojÃ³.
    // Pensar la lÃ³gica necesaria para realizar esto, usando los atributos de la
    // clase Juego.
    public void ronda() {
